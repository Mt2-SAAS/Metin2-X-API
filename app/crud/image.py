...
class CRUDImage:
    ...
    def get_paginated(self, page: int = 1, per_page: int = 20) -> Tuple[List[Image], int]:
    ...
    def get_by_type(self, image_type: str, page: int = 1, per_page: int = 20) -> Tuple[List[Image], int]:
    ...
    def search(self, search_term: str, page: int = 1, per_page: int = 20) -> Tuple[List[Image], int]:
